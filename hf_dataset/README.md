...
*Last updated: 2026-06-15T12:06:01Z*
...
| `cve` | CVE vulnerabilities | 3,784,456 | Current |
| `cpe` | CPE platform enumeration | 13,394,728 | Current |
...
| `epss` | EPSS exploit prediction scores | 682,700 | Current |
| `kev` | KEV known exploited vulns | 17,738 | Current |
| `vulnrichment` | CISA Vulnrichment (SSVC, CVSS, CWE enrichment) | 1,479,236 | Current |
| `ghsa` | GitHub Security Advisories | 364,437 | Current |
| `sigma` | Sigma detection rules | 33,294 | Current |
| `exploitdb` | ExploitDB public exploits | 347,133 | Current |
| `misp_galaxy` | MISP Galaxy threat intelligence clusters | 203,207 | Current |
| `lolbas` | LOLBAS living-off-the-land binaries | 3,620 | Current |
| `loldrivers` | LOLDrivers vulnerable/malicious drivers | 11,236 | Current |
| `atomic` | Atomic Red Team test definitions | 10,980 | Current |
| `nist_800_53` | NIST 800-53 → ATT&CK control mappings | 4,786 | Current |
| `nuclei` | Nuclei vulnerability detection templates | 97,904 | Current |
| `euvd` | EUVD European vulnerability database | 4,869 | Current |
| `osv` | OSV open-source vulnerabilities (23 ecosystems) | 6,695,146 | Current |
| `combined` | All sources merged (deduplicated) | 27,223,729 | Current |
