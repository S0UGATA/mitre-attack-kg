...
*Last updated: 2026-06-22T11:50:29Z*
...
| `cve` | CVE vulnerabilities | 3,810,456 | Current |
...
| `epss` | EPSS exploit prediction scores | 683,204 | Current |
| `kev` | KEV known exploited vulns | 17,782 | Current |
| `vulnrichment` | CISA Vulnrichment (SSVC, CVSS, CWE enrichment) | 1,493,263 | Current |
| `ghsa` | GitHub Security Advisories | 371,463 | Current |
| `sigma` | Sigma detection rules | 33,294 | Current |
| `exploitdb` | ExploitDB public exploits | 347,133 | Current |
| `misp_galaxy` | MISP Galaxy threat intelligence clusters | 203,287 | Current |
| `lolbas` | LOLBAS living-off-the-land binaries | 3,687 | Current |
| `loldrivers` | LOLDrivers vulnerable/malicious drivers | 11,601 | Current |
| `atomic` | Atomic Red Team test definitions | 10,980 | Current |
| `nist_800_53` | NIST 800-53 → ATT&CK control mappings | 4,786 | Current |
| `nuclei` | Nuclei vulnerability detection templates | 98,092 | Current |
| `euvd` | EUVD European vulnerability database | 4,881 | Current |
| `osv` | OSV open-source vulnerabilities (23 ecosystems) | 6,747,164 | Current |
| `combined` | All sources merged (deduplicated) | 27,324,066 | Current |
