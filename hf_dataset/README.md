...
*Last updated: 2026-09-07T11:32:06Z*
...
| `cve` | CVE vulnerabilities | 4,189,477 | Current |
| `cpe` | CPE platform enumeration | 14,049,902 | Current |
...
| `epss` | EPSS exploit prediction scores | 737,268 | Current |
| `kev` | KEV known exploited vulns | 18,580 | Current |
| `vulnrichment` | CISA Vulnrichment (SSVC, CVSS, CWE enrichment) | 1,732,038 | Current |
| `ghsa` | GitHub Security Advisories | 408,839 | Current |
| `sigma` | Sigma detection rules | 33,498 | Current |
| `exploitdb` | ExploitDB public exploits | 347,614 | Current |
| `misp_galaxy` | MISP Galaxy threat intelligence clusters | 224,605 | Current |
| `lolbas` | LOLBAS living-off-the-land binaries | 3,746 | Current |
| `loldrivers` | LOLDrivers vulnerable/malicious drivers | 12,301 | Current |
| `atomic` | Atomic Red Team test definitions | 11,442 | Current |
| `nist_800_53` | NIST 800-53 → ATT&CK control mappings | 4,786 | Current |
| `nuclei` | Nuclei vulnerability detection templates | 101,197 | Current |
| `euvd` | EUVD European vulnerability database | 5,127 | Current |
| `osv` | OSV open-source vulnerabilities (23 ecosystems) | 8,024,505 | Current |
| `combined` | All sources merged (deduplicated) | 29,993,841 | Current |
