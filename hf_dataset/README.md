...
*Last updated: 2026-07-27T10:02:46Z*
...
| `cve` | CVE vulnerabilities | 3,961,571 | Current |
| `cpe` | CPE platform enumeration | 13,697,146 | Current |
...
| `epss` | EPSS exploit prediction scores | 705,434 | Current |
| `kev` | KEV known exploited vulns | 18,116 | Current |
| `vulnrichment` | CISA Vulnrichment (SSVC, CVSS, CWE enrichment) | 1,613,516 | Current |
| `ghsa` | GitHub Security Advisories | 392,129 | Current |
| `sigma` | Sigma detection rules | 33,498 | Current |
| `exploitdb` | ExploitDB public exploits | 347,263 | Current |
| `misp_galaxy` | MISP Galaxy threat intelligence clusters | 205,797 | Current |
...
| `nuclei` | Nuclei vulnerability detection templates | 99,123 | Current |
| `euvd` | EUVD European vulnerability database | 4,974 | Current |
| `osv` | OSV open-source vulnerabilities (23 ecosystems) | 7,423,447 | Current |
| `combined` | All sources merged (deduplicated) | 28,621,556 | Current |
