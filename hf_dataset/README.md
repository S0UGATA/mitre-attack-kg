...
*Last updated: 2026-08-31T12:44:04Z*
...
| `cve` | CVE vulnerabilities | 4,159,386 | Current |
| `cpe` | CPE platform enumeration | 13,996,274 | Current |
...
| `epss` | EPSS exploit prediction scores | 732,714 | Current |
| `kev` | KEV known exploited vulns | 18,465 | Current |
| `vulnrichment` | CISA Vulnrichment (SSVC, CVSS, CWE enrichment) | 1,713,566 | Current |
| `ghsa` | GitHub Security Advisories | 405,042 | Current |
| `sigma` | Sigma detection rules | 33,498 | Current |
| `exploitdb` | ExploitDB public exploits | 347,449 | Current |
| `misp_galaxy` | MISP Galaxy threat intelligence clusters | 221,671 | Current |
| `lolbas` | LOLBAS living-off-the-land binaries | 3,728 | Current |
| `loldrivers` | LOLDrivers vulnerable/malicious drivers | 11,763 | Current |
| `atomic` | Atomic Red Team test definitions | 11,085 | Current |
| `nist_800_53` | NIST 800-53 → ATT&CK control mappings | 4,786 | Current |
| `nuclei` | Nuclei vulnerability detection templates | 101,047 | Current |
| `euvd` | EUVD European vulnerability database | 5,076 | Current |
| `osv` | OSV open-source vulnerabilities (23 ecosystems) | 7,991,996 | Current |
| `combined` | All sources merged (deduplicated) | 29,846,422 | Current |
