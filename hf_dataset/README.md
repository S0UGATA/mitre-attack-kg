...
*Last updated: 2026-08-24T06:57:39Z*
...
| `cve` | CVE vulnerabilities | 4,125,242 | Current |
| `cpe` | CPE platform enumeration | 13,921,918 | Current |
...
| `epss` | EPSS exploit prediction scores | 727,658 | Current |
| `kev` | KEV known exploited vulns | 18,348 | Current |
| `vulnrichment` | CISA Vulnrichment (SSVC, CVSS, CWE enrichment) | 1,690,236 | Current |
| `ghsa` | GitHub Security Advisories | 401,715 | Current |
| `sigma` | Sigma detection rules | 33,498 | Current |
| `exploitdb` | ExploitDB public exploits | 347,442 | Current |
| `misp_galaxy` | MISP Galaxy threat intelligence clusters | 206,235 | Current |
| `lolbas` | LOLBAS living-off-the-land binaries | 3,719 | Current |
| `loldrivers` | LOLDrivers vulnerable/malicious drivers | 11,745 | Current |
| `atomic` | Atomic Red Team test definitions | 11,073 | Current |
| `nist_800_53` | NIST 800-53 → ATT&CK control mappings | 4,786 | Current |
| `nuclei` | Nuclei vulnerability detection templates | 100,499 | Current |
| `euvd` | EUVD European vulnerability database | 5,043 | Current |
| `osv` | OSV open-source vulnerabilities (23 ecosystems) | 7,952,833 | Current |
| `combined` | All sources merged (deduplicated) | 29,650,866 | Current |
