...
*Last updated: 2026-06-08T10:33:24Z*
...
| `cve` | CVE vulnerabilities | 3,754,133 | Current |
| `cpe` | CPE platform enumeration | 13,358,800 | Current |
...
| `epss` | EPSS exploit prediction scores | 676,886 | Current |
| `kev` | KEV known exploited vulns | 17,659 | Current |
| `vulnrichment` | CISA Vulnrichment (SSVC, CVSS, CWE enrichment) | 1,463,656 | Current |
| `ghsa` | GitHub Security Advisories | 361,905 | Current |
| `sigma` | Sigma detection rules | 33,294 | Current |
| `exploitdb` | ExploitDB public exploits | 347,126 | Current |
| `misp_galaxy` | MISP Galaxy threat intelligence clusters | 203,185 | Current |
...
| `nuclei` | Nuclei vulnerability detection templates | 97,608 | Current |
| `euvd` | EUVD European vulnerability database | 4,848 | Current |
| `osv` | OSV open-source vulnerabilities (23 ecosystems) | 6,686,317 | Current |
| `combined` | All sources merged (deduplicated) | 27,124,279 | Current |
