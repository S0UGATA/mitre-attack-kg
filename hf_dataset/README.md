...
*Last updated: 2026-08-03T09:40:10Z*
...
| `cve` | CVE vulnerabilities | 3,988,205 | Current |
| `cpe` | CPE platform enumeration | 13,749,960 | Current |
...
| `epss` | EPSS exploit prediction scores | 709,404 | Current |
| `kev` | KEV known exploited vulns | 18,149 | Current |
| `vulnrichment` | CISA Vulnrichment (SSVC, CVSS, CWE enrichment) | 1,631,655 | Current |
| `ghsa` | GitHub Security Advisories | 394,569 | Current |
| `sigma` | Sigma detection rules | 33,498 | Current |
| `exploitdb` | ExploitDB public exploits | 347,263 | Current |
| `misp_galaxy` | MISP Galaxy threat intelligence clusters | 205,821 | Current |
...
| `nuclei` | Nuclei vulnerability detection templates | 99,482 | Current |
| `euvd` | EUVD European vulnerability database | 4,983 | Current |
| `osv` | OSV open-source vulnerabilities (23 ecosystems) | 7,542,272 | Current |
| `combined` | All sources merged (deduplicated) | 28,844,818 | Current |
