...
*Last updated: 2026-07-20T09:05:20Z*
...
| `cve` | CVE vulnerabilities | 3,930,819 | Current |
| `cpe` | CPE platform enumeration | 13,610,442 | Current |
...
| `epss` | EPSS exploit prediction scores | 698,982 | Current |
| `kev` | KEV known exploited vulns | 18,050 | Current |
| `vulnrichment` | CISA Vulnrichment (SSVC, CVSS, CWE enrichment) | 1,586,581 | Current |
| `ghsa` | GitHub Security Advisories | 385,179 | Current |
| `sigma` | Sigma detection rules | 33,498 | Current |
| `exploitdb` | ExploitDB public exploits | 347,263 | Current |
| `misp_galaxy` | MISP Galaxy threat intelligence clusters | 205,745 | Current |
...
| `nuclei` | Nuclei vulnerability detection templates | 98,637 | Current |
| `euvd` | EUVD European vulnerability database | 4,956 | Current |
| `osv` | OSV open-source vulnerabilities (23 ecosystems) | 7,247,708 | Current |
| `combined` | All sources merged (deduplicated) | 28,287,402 | Current |
