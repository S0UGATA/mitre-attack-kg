...
*Last updated: 2026-05-25T10:01:56Z*
...
| `cve` | CVE vulnerabilities | 3,708,328 | Current |
| `cpe` | CPE platform enumeration | 13,213,712 | Current |
...
| `epss` | EPSS exploit prediction scores | 669,494 | Current |
| `kev` | KEV known exploited vulns | 17,550 | Current |
| `vulnrichment` | CISA Vulnrichment (SSVC, CVSS, CWE enrichment) | 1,432,099 | Current |
| `ghsa` | GitHub Security Advisories | 357,189 | Current |
| `sigma` | Sigma detection rules | 33,294 | Current |
| `exploitdb` | ExploitDB public exploits | 346,881 | Current |
| `misp_galaxy` | MISP Galaxy threat intelligence clusters | 201,429 | Current |
...
| `atomic` | Atomic Red Team test definitions | 10,944 | Current |
| `nist_800_53` | NIST 800-53 → ATT&CK control mappings | 4,786 | Current |
| `nuclei` | Nuclei vulnerability detection templates | 96,961 | Current |
| `euvd` | EUVD European vulnerability database | 4,818 | Current |
| `osv` | OSV open-source vulnerabilities (23 ecosystems) | 6,520,216 | Current |
| `combined` | All sources merged (deduplicated) | 26,720,866 | Current |
